Validação de CPF// Função para limpar e sanitizar a entrada do usuário, removendo espaços e caracteres especiais
...
// Exemplo de uso das funções com todas as práticas recomendadas
const inputCPF = "123.456.789-09";

try {
  const sanitizedInput = sanitizeInput(inputCPF);
  ...
  handleError("Ocorreu um erro ao validar o CPF.");
}
